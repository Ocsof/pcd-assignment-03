        ...
        Behaviors.receiveMessage ( msg => {
          ...
          msg match
            ...
            case FireStationList(listing) =>
              ...
              PluviometerActor(pluviometer, zonePluviometers, listing, views)

            case PluviometerList(listing) =>
              ctx.log.info2("{}: new set of Pluviometers of length {}", ctx.self.path.name, listing.size)
              PluviometerActor(pluviometer, listing, zoneFireStations, views)
            ...
            case PluviometerViewList(listing) => //invio alla view che si è registrata il mio stato
              ...
              PluviometerActor(pluviometer, zonePluviometers, zoneFireStations, listing)
